  ...
  <div>
      ...
      <template #brand>
        ...
        <div class="column is-full has-text-centered" >
            <h2 class="is-size-3" style="padding: 10px"><b>Precio mensual por miembro</b></h2>
            <h3>Esta es la aportación mensual recomendada por cada miembro de tu grupo, ¿te parece bien?</h3>
